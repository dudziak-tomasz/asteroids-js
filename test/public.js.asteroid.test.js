...
test('Should create new asteroid and assign default data', () => {
    ...
    assert.deepEqual(-1.35 <= asteroid.speedX && asteroid.speedX <= -0.3 || 0.3 <= asteroid.speedX && asteroid.speedX <= 1.35, true)
    assert.deepEqual(-1.35 <= asteroid.speedY && asteroid.speedY <= -0.3 || 0.3 <= asteroid.speedY && asteroid.speedY <= 1.35, true)
    assert.deepEqual(-0.7 <= asteroid.rotation && asteroid.rotation <= -0.3 || 0.3 <= asteroid.rotation && asteroid.rotation <= 0.7, true)
    assert.deepEqual(asteroid.left <= 640 || 1280 <= asteroid.left, true)
    assert.deepEqual(asteroid.top <= 360 || 720 <= asteroid.top, true)
...
test('Should create new asteroid and assign given data for size = 1', () => {
    ...
    assert.deepEqual(-2.4 <= asteroid.speedX && asteroid.speedX <= -0.3 || 0.3 <= asteroid.speedX && asteroid.speedX <= 2.4, true)
    assert.deepEqual(-2.4 <= asteroid.speedY && asteroid.speedY <= -0.3 || 0.3 <= asteroid.speedY && asteroid.speedY <= 2.4, true)
...
test('Should create new asteroid and assign given data for size = 2', () => {
    ...
    assert.deepEqual(-1.7 <= asteroid.speedX && asteroid.speedX <= -0.3 || 0.3 <= asteroid.speedX && asteroid.speedX <= 1.7, true)
    assert.deepEqual(-1.7 <= asteroid.speedY && asteroid.speedY <= -0.3 || 0.3 <= asteroid.speedY && asteroid.speedY <= 1.7, true)
